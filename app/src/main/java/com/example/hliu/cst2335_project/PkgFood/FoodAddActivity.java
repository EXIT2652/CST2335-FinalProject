...
/*    protected static final String ACTIVITY_NAME = "AddItemsActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.food_activity_add_item);
        ...
        addDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new DatePickerDialog(FoodAddActivity.this, date, myCalendar.get(Calendar.YEAR),
        ...
        addTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                myTimePicker = new TimePickerDialog(FoodAddActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        buttonAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(FoodAddActivity.this, FoodFragmentListView.class);
