...
public class FoodFragmentListView extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.food_activity_fragment_listview);
        ...
        button_add.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(FoodFragmentListView.this, FoodAddActivity.class);
        ...
        listView.setAdapter(new ArrayAdapter<String>(this, R.layout.food_activity_cell_layout, listItems));
